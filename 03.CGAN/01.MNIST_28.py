...
dataset = epfd.MNISTDataSetForPytorch(root=DATA_PATH, train=True, transform=trans)
...
for epoch in range(1, EPOCHS + 1):
    ...
    tv.utils.save_image(test_images.data[:100],'outputs/mnist_%03d.png' % (epoch),nrow=10)
