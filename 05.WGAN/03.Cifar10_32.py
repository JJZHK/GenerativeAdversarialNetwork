...
dataset = epfd.Cifar10DataSetForPytorch(root=DATA_PATH, transform=trans)
...
for epoch in range(1, EPOCHS + 1):
    ...
    tv.utils.save_image(fake_u.data,'outputs/Cifar10_%03d.png' % epoch, normalize=True,nrow=10)