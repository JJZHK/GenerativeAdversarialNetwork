...
class Discriminator(torch.nn.Module):
    def __init__(self):
        ...
        self.conv5 = torch.nn.Sequential(
            torch.nn.Conv2d(64 * 8, 64 * 8, 4, 2, 0, bias=False)
        )
...
predict_noise = torch.FloatTensor(100, NOISE_DIM).normal_(0, 1)
...
for epoch in range(1, EPOCHS + 1):
    ...
    tv.utils.save_image(test_images.data[:100],
                            'outputs/stl64_%03d.png' % (epoch), nrow=10, normalize=True)
